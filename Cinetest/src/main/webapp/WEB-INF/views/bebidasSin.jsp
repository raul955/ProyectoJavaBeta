...
<nav class="navbar navbar-expand-sm navbar-light bg-light">
	...
	<div align="center" class="row justify-content-center">
		<div class="col-auto">
			...
			<table id="tablaPs" border="1px" class="mt-5 table table-striped table-inverse table-responsive table-center table-bordered text-center">
				<tr>
				...
				<tr>
					...
					<form action=bebidasSin method="POST">
						<tr>
