...
<nav class="navbar navbar-expand-sm navbar-light bg-light">
	...
	<div align="center" class="row justify-content-center">
		<div class="col-auto">
			...
			<table id="tablaP" border="1px" class="mt-5 table table-striped table-inverse table-responsive table-center table-bordered text-center">
				<tr>
					...
					<td style="height: 28px; width: 150px;">Ud. Eliminar</td>
					<td style="height: 28px; width: 150px;">Acción</td>
				<tr>
					<c:forEach items="${listaPel}" var="info">
					<form action=borrarProducto method="POST">
						<tr>
							<td><input type="text" readonly="readonly" name="codProd" value="${info.id}"></td>
							<td><input type="text" readonly="readonly" name="nombre" value="${info.nombre}"></td>
							<td><input type="text" readonly="readonly" name="descipcion" value="${info.descripcion}"></td>
							...
							<td><input type="text" readonly="readonly" name="pedidos" value="${info.numComprar}"></td>
							<td><input type="number" name="unidades" min=1 max="${info.numComprar}"></td>
							<td>
							<button class="btn btn-success" type="submit" name="comprar">Eliminar</button></form></td>
						</tr>
					</form>
					</c:forEach>
			</table>
				...
				<form action=vaciarCarromato method="POST"> 
				<button class="btn btn-success" type="submit" name="Vaciar">Vaciar Carromato</button>
				</form>
				<form action=realizarPedido method="POST"> 
				<button class="btn btn-success" type="submit" name="comprar">Realizar Pedido</button>
				</form>
				</br> <a
